...
{
    internal class childrenHarmonyHediffComp_Discoverable_CheckDiscovered_Patch_Transpile
    {
        ...
        public static IEnumerable<CodeInstruction> CheckDiscovered_Pre(IEnumerable<CodeInstruction> instructions,
            ILGenerator iLGenerator)
        {
            var matchesFound = new int[2];
            ...
            while (i < instructionsList.Count)
            {
                ...
                )
                {
                    ...
                    instructionsList[i].operand =
                        Method(typeof(childrenHarmonyHediffComp_Discoverable_CheckDiscovered_Patch_Transpile),
                            "getDiscovered");
