...
namespace RimThreaded
{
    ...
    {
        public bool disableforcedslowdowns;
        public bool disablesomealerts;
        ...
        public override void ExposeData()
        {
            ...
            Scribe_Values.Look(ref disablesomealerts, "disablesomealets");
            Scribe_Values.Look(ref disableforcedslowdowns, "disableforcedslowdowns");
        }

        public void DoWindowContents(Rect inRect)
        {
            var viewRect = new Rect(0f, 0f, inRect.width - 16f, 1200f);
            ...
            Widgets.Label(listing_Standard.GetRect(25f),
                "Timeout (in miliseconds) waiting for threads (default: 8000):");
            ...
            Widgets.TextFieldNumeric(listing_Standard.GetRect(30f), ref timeSpeedSuperfast,
                ref timeSpeedSuperfastBuffer);
            Widgets.Label(listing_Standard.GetRect(25f), "Timespeed Ultrafast (multiply by 60 for Max TPS):");
            Widgets.TextFieldNumeric(listing_Standard.GetRect(30f), ref timeSpeedUltrafast,
                ref timeSpeedUltrafastBuffer);
            Widgets.CheckboxLabeled(listing_Standard.GetRect(27f), "Disable alert updates at 4x speed:",
                ref disablesomealerts);
            Widgets.CheckboxLabeled(listing_Standard.GetRect(27f), "Disable forced slowdowns on events like combat:",
                ref disableforcedslowdowns);
